...
grader.addManualPart('2a', 2, description="Written question: proving value function upper bounds")
grader.addManualPart('2b', 2, description="Written question: manipulating value function upper bounds")
grader.addManualPart('2c', 4, description="Written question: proving how reward bonuses can preserve the optimal policy")
